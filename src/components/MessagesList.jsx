          ...
          <div className="flex">
            <div className="flex-grow">
              <div className="flex items-center gap-3">
                ...
                >
                  {message.speech === "formal" ? "औपचारिक" : "अनौपचारिक"}
                </span>
                {renderEnglish(message.answer.english)}
              </div>

              {renderMarathi(message.answer.marathi)}
            </div>
